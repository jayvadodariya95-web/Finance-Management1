        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmergencyMobileNumber = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlySalary = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: false),
                    Previous_CTC = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: true),
                    Current_CTC = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: false),
                    JoinDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Taken_Leave = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BranchId = table.Column<int>(type: "int", nullable: true),
                    IsMainPartner = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeDocuments", x => new { x.EmployeeId, x.DocId });
                    table.ForeignKey(
                        name: "FK_EmployeeDocuments_Documents_DocId",
                        column: x => x.DocId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagerEmail = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    ManagerContact = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ProjectValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    LeaveApplyWay = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    IsSmooth = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ClientManagerName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    ClientManagerEmail = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    ClientManagerContact = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    MobileNumberUsed = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    InterviewingUserId = table.Column<int>(type: "int", nullable: true),
                    IsToolUsed = table.Column<bool>(type: "bit", nullable: true),
                    ManagedByPartnerId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Revenue_From = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Revenues_Partners_Partner_id",
                        column: x => x.Partner_id,
                        principalTable: "Partners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Revenues_Projects_Project_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeDocuments_DocId",
                table: "EmployeeDocuments",
                column: "DocId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeDocuments_EmployeeId_DocId",
                table: "EmployeeDocuments",
                columns: new[] { "EmployeeId", "DocId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlyExpenses_PartnerId_Month_Year",
                table: "MonthlyExpenses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_ManagedByPartnerId",
                table: "Projects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Revenues_Partner_id_Date",
                table: "Revenues",
                columns: new[] { "Partner_id", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_Revenues_Project_id",
                table: "Revenues",
                column: "Project_id");
